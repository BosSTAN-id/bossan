...
/* @var $searchModel app\modules\parameter\models\RefSekolahSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Sekolah');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="ref-sekolah-index">

    <p>
        <?= Html::a(Yii::t('app', 'Tambah Sekolah'), ['create'], [
