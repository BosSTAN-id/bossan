...
$this->params['breadcrumbs'][] = 'Kondisi';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="ta-aset-tetap-index">
    <?php ActiveForm::begin(['action' => ['bulk-update']]); ?>
    <?= GridView::widget([
        'id' => 'ta-aset-tetap',    
        ...
        'panel'=>[
            ...
            'after'=>
                ...
                Select2::widget([
                    'name' => 'kondisi_aset', 
                    'data' => [1 => 'Baik', 2 => 'Rusak Sedang/Ringan', 3 => 'Rusak Berat'],
                    'options' => ['placeholder' => 'Kondisi ...'],
                ]).
                '</div><div class="col-md-3">'.
                Html::submitButton( '<span class="glyphicon glyphicon-pencil"></span> Ubah Kondisi', ['class' => 'btn btn-warning', 'data-confirm' => "Yakin mengubah kondisi item yang dipilih?",]).
                '</div></div>',
        ],
