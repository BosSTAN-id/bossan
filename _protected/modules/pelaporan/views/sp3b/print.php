...
// $pdf->MultiCell(160,4,$ttd['Alamat'], '', 'C', 0);
...
// $pdf->MultiCell(70,8,'Pangkalan Balai, '.DATE('j', strtotime($model['Tgl_Usulan'])).' '.bulan(DATE('m', strtotime($model['Tgl_Usulan']))).' '.DATE('Y', strtotime($model['Tgl_Usulan'])), '', 'L', 0);
...
// $pdf->MultiCell(70,6,'Kepala Badan Pengelolaan Keuangan dan Aset Daerah Selaku Bendahara Umum Daerah', '', 'L', 0);
// $pdf->SetXY(130,$pdf->GetY());
...
// $pdf->MultiCell(70,6,': '.$model->No_Usulan, '', 'L', 0);
// $y = $pdf->GetY();
// $pdf->SetXY(15,$y);
// $pdf->MultiCell(25,6,'Lampiran', '', 'L', 0);
// $pdf->SetXY(35,$y);
// $pdf->MultiCell(70,6,': '.$model['Lampiran'], '', 'L', 0);
// $y = $pdf->GetY();
// $pdf->SetXY(15,$y);
// $pdf->MultiCell(25,6,'Perihal', '', 'L', 0);
// $pdf->SetXY(35,$y);
// $pdf->MultiCell(70,6,': '.$model['Perihal'], '', 'L', 0);
// $y1 = $pdf->GetY();
...
// $pdf->SetXY(15,$y);
// $pdf->SetFont('Arial','',11);
// $pdf->MultiCell(185,6,'Dengan memperhatikan '.$model->Memperhatikan.', bersama ini kami mengajukan '.$model->Perihal.' (rincian penggunaan dana terlampir) sebagai berikut:', '', 'J', 0);
...
// $ttk = 85;
// $pdf->SetXY(15,$y);
// $pdf->MultiCell(70,6,'1.  SKPD', '', 'L', 0);
// $pdf->SetXY($ttk,$y);
// $pdf->MultiCell(115,6,': '.ucwords($model->subunit->Nm_Sub_Unit), '', 'L', 0);
// $y = $pdf->GetY();
// $pdf->SetXY(15,$y);
// $pdf->MultiCell(70,6,'2.  Alamat', '', 'L', 0);
// $pdf->SetXY($ttk,$y);
// $pdf->MultiCell(115,6,': '.ucwords(strtolower($ttd['Alamat'])), '', 'L', 0);
// $y = $pdf->GetY();
// $pdf->SetXY(15,$y);
// $pdf->MultiCell(70,6,'3.  No DPA/DPPA/DPAL SKPD', '', 'L', 0);
// $pdf->SetXY($ttk,$y);
// $pdf->MultiCell(115,6,': Terlampir', '', 'L', 0);
// $y = $pdf->GetY();
// $pdf->SetXY(15,$y);
// $pdf->MultiCell(70,6,'4.  Tahun Anggaran', '', 'L', 0);
// $pdf->SetXY($ttk,$y);
// $pdf->MultiCell(115,6,': '.$model['Tahun'], '', 'L', 0);
// $y = $pdf->GetY();
// $pdf->SetXY(15,$y);
// $pdf->MultiCell(70,6,'5.  Bulan', '', 'L', 0);
// $pdf->SetXY($ttk,$y);
// $pdf->MultiCell(115,6,': '.bulan(DATE('m', strtotime($model['Tgl_Usulan']))), '', 'L', 0);$y = $pdf->GetY();
// $pdf->SetXY(15,$y);
// $pdf->MultiCell(70,6,'6.  Jumlah Pembayaran yang Diminta', '', 'L', 0);
// $pdf->SetXY($ttk,$y);
// $pdf->MultiCell(115,6,': Rp'.number_format($jumlahusulan, 0, ',', '.'), '', 'L', 0);$y = $pdf->GetY();
// $pdf->SetXY(15,$y);
// $pdf->MultiCell(70,6,'7.  Untuk Keperluan', '', 'L', 0);
// $pdf->SetXY($ttk,$y);
// $pdf->MultiCell(115,6,': '.$model['Uraian'], '', 'L', 0);$y = $pdf->GetY();
// $pdf->SetXY(15,$y);
// $pdf->MultiCell(70,6,'8.  Bendahara Pengeluaaran', '', 'L', 0);
// $pdf->SetXY($ttk,$y);
// $pdf->MultiCell(115,6,': '.$model['Nm_Bendahara'], '', 'L', 0);$y = $pdf->GetY();
// $pdf->SetXY(15,$y);
// $pdf->MultiCell(70,6,'9.  Alamat', '', 'L', 0);
// $pdf->SetXY($ttk,$y);
// $pdf->MultiCell(115,6,': '.ucwords(strtolower($ttd['Alamat'])), '', 'L', 0);

// $y = $pdf->GetY()+4;
// $pdf->SetXY(15,$y);
// $pdf->MultiCell(185,6,'Demikianlah surat permohonan ini, atas bantuan dan kerjasama yang baik diucapkan terima kasih.', '', 'J', 0);
...
// $pdf->SetXY(130,$y);
// $pdf->SetFont('Arial','',11);
// $pdf->MultiCell(70,6,'Pangkalan Balai, '.DATE('d', strtotime($model['Tgl_Usulan'])).' '.bulan(DATE('m', strtotime($model['Tgl_Usulan']))).' '.DATE('Y', strtotime($model['Tgl_Usulan'])), '', 'C', 0);
...
// //qr code untuk cek
// $pdf->Image("http://api.qrserver.com/v1/create-qr-code/?size=150x150&data=$link", 20, 310 ,15,0,'PNG');
...
$pdf->MultiCell(185, 6,'ATAS SP3B: '.$model['no_sp3b'], '', 'C', 0);
