...
/* @var $model app\modules\pelaporan\models\TaSP3BSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="ta-sp3-b-search">
    ...
    <?= $form->field($model, 'tgl_sp3b')->textInput(
                ['class' => 'form-control input-sm pull-right','placeholder' => Yii::t('app', 'tgl_sp3b')])->label(false) ?>
    ...
    <?= $form->field($model, 'pendapatan')->textInput(
                ['class' => 'form-control input-sm pull-right','placeholder' => Yii::t('app', 'pendapatan')])->label(false) ?>
