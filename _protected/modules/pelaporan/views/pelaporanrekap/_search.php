...
<div class="row col-md-12">   
    ...
    <div class="col-md-3">
        <?php
            $model->pendidikan_id = isset(Yii::$app->request->queryParams['Laporan']['pendidikan_id']) ? Yii::$app->request->queryParams['Laporan']['pendidikan_id'] : '';
            echo $form->field($model, 'pendidikan_id')->widget(Select2::classname(), [
                'data' => ArrayHelper::map(\app\models\RefPendidikan::find()->all(), 'id', 'jenis'),
                'options' => ['class' =>'form-control input-sm' ,'placeholder' => 'Jenjang Pendidikan ...', 
                // 'onchange'=> 'this.form.submit()'
                ],
                'pluginOptions' => [
                    'allowClear' => true
