...
/**
 * Sp3bController implements the CRUD actions for TaSP3B model.
 */
class Sp3bController extends Controller
{
    ...
    /**
     * Displays a single TaSP3B model.
     * @param string $tahun
     * @param string $no_sp3b
     * @return mixed
     */
    public function actionView($tahun, $no_sp3b)
    {
        IF($this->cekakses() !== true){
            Yii::$app->getSession()->setFlash('warning',  'Anda tidak memiliki hak akses');
            return $this->redirect(Yii::$app->request->referrer);
    ...
    /**
     * Updates an existing TaSP3B model.
    ...
    /**
     * Deletes an existing TaSP3B model.
    ...
    public function actionDelete($tahun, $no_sp3b)
    {
        ...
        $this->findModel($tahun, $no_sp3b)->delete();

        return $this->redirect(Yii::$app->request->referrer);
    }

    /**
     * Finds the TaSP3B model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $tahun
     * @param string $no_sp3b
     * @return TaSP3B the loaded model
