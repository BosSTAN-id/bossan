...
class LaporanpenatausahaanController extends Controller
{
                ...
                switch ($Kd_Laporan) {
                    ...
                    //     break;
                        ...
                        $totalCount = Yii::$app->db->createCommand("
                            ...
                            FROM
                                ta_trans_skpd AS a
                            INNER JOIN ta_trans_sts AS b ON a.Tahun = b.Tahun
                        ...
                        $data = new SqlDataProvider([
                            'sql' => "
                                    ...
                                    d.Nm_Sub_Bidang,
                                        ...
                                        SUM(
                                        CASE
                                            WHEN b.D_K = 1 THEN b.Nilai
                                            WHEN b.D_K = 2 THEN - (b.Nilai)
                                        END) AS Saldo
                                    FROM
                                        ta_trans_skpd AS a
                                    INNER JOIN ta_trans_sts AS b ON a.Tahun = b.Tahun
    ...
    protected function cekakses(){
        ...
        IF(Yii::$app->user->identity){
            $akses = \app\models\RefUserMenu::find()->where(['kd_user' => Yii::$app->user->identity->kd_user, 'menu' => 211])->one();
            IF($akses){
                return true;
            }else{
                return false;
