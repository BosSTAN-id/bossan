...
$this->title = 'Pagu/Referensi Dana Transfer';
...
<div class="ta-trans3-index">
    ...
    <p>
        <?= Html::a('Tambah Referensi & Pagu', ['create'], [
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                $dataProvider->query->where('Tahun = '.$model->Tahun.' AND Kd_Trans_1 = '.$model->Kd_Trans_1.' AND Kd_Trans_2 = '.$model->Kd_Trans_2.' AND Kd_Trans_3 = '.$model->Kd_Trans_3);                              
...
");
$this->registerJs("
    $('#myModalSkpdubah').on('show.bs.modal', function (event) {
        var button = $(event.relatedTarget)
        var modal = $(this)
        var title = button.data('title') 
        var href = button.attr('href') 
