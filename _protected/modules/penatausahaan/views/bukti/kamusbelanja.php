    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'format' => 'decimal',
                'value' => function($model){
                    return $model['sisa_anggaran'];
                }
            ],
            [
                'label' => 'Pilih',
                'format' => 'raw',
                'value' => function($model) use ($kd_program, $kd_sub_program, $kd_kegiatan, $kegiatan){
                    return Html::a('<i class="glyphicon glyphicon-arrow-right"></i>', 'javascript:;', [
                        ...
                        'onclick' => '
                                ...
                                document.querySelector(\'span#kegiatan\').innerHTML = "<i>Kegiatan '.$kegiatan->uraian_kegiatan.'</i>";
