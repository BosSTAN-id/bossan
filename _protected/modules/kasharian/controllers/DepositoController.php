...
class DepositoController extends Controller
{
    ...
    /**
     * Displays a single TaDeposito model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new TaDeposito model.
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->Kd_Deposito]);
        } else {
    ...
    /**
     * Updates an existing TaDeposito model.
    ...
    /**
     * Deletes an existing TaDeposito model.
