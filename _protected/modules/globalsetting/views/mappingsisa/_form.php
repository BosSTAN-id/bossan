...
<div class="ref-penerimaan-sekolah2-form">
    ...
    <?php
            ...
            $skpd = $connection->createCommand('SELECT CONCAT(kd_penerimaan_1,".", kd_penerimaan_2) AS penerimaan2, CONCAT(kd_penerimaan_1,".", kd_penerimaan_2," ", uraian) AS uraian FROM ref_penerimaan_sekolah_2 WHERE kd_penerimaan_1 != 1');
            $data = $skpd->queryAll();
            ...
            echo $form->field($model, 'penerimaan2')->widget(Select2::classname(), [
                'data' => ArrayHelper::map($data, 'penerimaan2', 'uraian'),
