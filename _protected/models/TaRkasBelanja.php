...
class TaRkasBelanja extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'Kd_Rek_2' => Yii::t('app', 'Kelompok'),
            'Kd_Rek_1' => Yii::t('app', 'Akun'),
            'Kd_Rek_3' => Yii::t('app', 'Jenis'),
            'Kd_Rek_4' => Yii::t('app', 'Objek'),
            'Kd_Rek_5' => Yii::t('app', 'Rincian Objek'),
            'kd_penerimaan_1' => Yii::t('app', 'Penerimaan 1'),
            'kd_penerimaan_2' => Yii::t('app', 'Penerimaan 2'),
            'komponen_id' => Yii::t('app', 'Komponen'),
